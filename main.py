    ...
    def data_prj(self):
        ...
        while True:
            ...
            if prj_bus == '1' or prj_flight == '2':
                ...
                print('Invalid answer')
        query = f'INSERT INTO project (prj_name, prj_description, prj_country, prj_city, prj_date_start, prj_date_end, prj_skills, prj_job, prj_flight, prj_house, prj_food, prj_bus) VALUES (\'{prj_name}\', \'{prj_description}\',\'{prj_country}\',\'{prj_city}\', \'{prj_date_start}\', \'{prj_date_end}\', \'{prj_skills}\', \'{prj_job}\', \'{prj_flight}\', \'{prj_house}\', \'{prj_food}\', \'{prj_bus}\')'       
        connect(query)    
